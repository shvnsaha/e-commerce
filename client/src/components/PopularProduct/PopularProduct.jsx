...
const PopularProduct = () => {
    ...
    const getProducts = async () => {
        const res = await axiosSecure.get(`/products?page=${page}&limit=${limit}&sortField=totalsold&sortOrder=desc`)
        return res
    }
    ...
    return (
        <div className='rounded-xl m-6' data-aos='fade-down' data-aos-delay='400'>
            ...
            <div className='text-center  mb-4' data-aos='fade-down' data-aos-delay='600'>
                ...
                <h2 className='text-lg font-medium text-red-600'>Popular Products</h2>
            </div>
            <div className='pb-6'>
